...
function Typo(_a) {
    ...
    return jsx("div", __assign({ className: "stacktech-typography-text--".concat(variant, " ").concat(type !== undefined ? "stacktech-typography-font--".concat(type) : '', " ").concat(className !== null && className !== void 0 ? className : '') }, props, { children: children }));
}
...
function Button(_a) {
    ...
    var label = useMemo(function () {
        switch (size) {
            case 'small':
                return jsx(Typo, { className: "stacktech-button__label", variant: "s4", children: children });
            case 'regular':
                return jsx(Typo, { className: "stacktech-button__label", variant: "s3", children: children });
            case 'large':
                return jsx(Typo, { className: "stacktech-button__label", variant: "s2", children: children });
        }
    }, [children, size]);
    return (jsxs("button", __assign({ className: "stacktech-button stacktech-button--".concat(variant, " stacktech-button--").concat(size, " ").concat(disabled ? 'stacktech-button--disabled' : '', " ").concat((_b = props.className) !== null && _b !== void 0 ? _b : ''), onClick: onClick, disabled: disabled }, props, { children: [leftIcon && jsx("div", { className: "stacktech-button__left-icon", children: leftIcon }), label, rightIcon && jsx("div", { className: "stacktech-button__right-icon", children: rightIcon })] })));
}
...
function Dropdown(_a) {
    ...
    var _d = useState("bottom"), listPosition = _d[0], setListPosition = _d[1];
    ...
    return (jsxs("div", __assign({ className: "stacktech-dropdown stacktech-dropdown__component ".concat(disabled ? "stacktech-dropdown__component--disabled" : "", " ").concat(className !== null && className !== void 0 ? className : ""), ref: dropdownRef }, props, { children: [label && (jsx("label", { className: "stacktech-dropdown__label", htmlFor: props.id, children: jsx(Typo, { variant: "p3", children: label }) })), jsxs("div", { className: "stacktech-dropdown__menu", children: [jsxs("button", { type: "button", className: "stacktech-dropdown__menu__trigger ".concat(open ? "stacktech-dropdown__menu__trigger--open" : ""), onClick: function () { return !disabled && setOpen(function (prev) { return !prev; }); }, disabled: disabled, ref: triggerRef, "aria-expanded": open, "aria-haspopup": "listbox", id: props.id, children: [jsx(Typo, { variant: "p3", className: "stacktech-dropdown__menu__trigger__value", children: value.label || placeholder }), jsx("svg", { className: "stacktech-dropdown__menu__trigger__chevron ".concat(open ? "stacktech-dropdown__menu__trigger__chevron--open" : ""), xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", children: jsx("path", { d: "M13.2802 6L8.93355 10.3467C8.42021 10.86 7.58022 10.86 7.06688 10.3467L2.72021 6", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) })] }), !disabled && (jsx("ul", { className: "stacktech-dropdown__menu__list ".concat(open ? "stacktech-dropdown__menu__list--open" : "", " stacktech-dropdown__menu__list--").concat(listPosition), ref: listRef, role: "listbox", "aria-activedescendant": value.value, children: options.map(function (option) { return (jsx("li", { className: "stacktech-dropdown__menu__list__option ".concat(option.value === value.value
                                ? "stacktech-dropdown__menu__list__option--selected"
                                : ""), onClick: function () { return handleSelect(option); }, role: "option", "aria-selected": option.value === value.value, id: option.value, children: jsx(Typo, { variant: "p3", children: option.label }) }, option.value)); }) }))] })] })));
}

export { Button, Dropdown, Typo };
